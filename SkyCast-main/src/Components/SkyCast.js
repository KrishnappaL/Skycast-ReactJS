	...
	return ( 
		<div className="App"> 
			...
			{weather.error && ( 
				...
				<div> 
					<h2 className='text-center text-lg md:text-2xl font-semibold '>SkyCast - Weather App</h2>
					...
					<div className='data-element'>
						<div className='flex items-center gap-2'><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" className='data-element__details--icons'><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M3 8h2m2-2.143V5.5A2.5 2.5 0 1 1 9.5 8H8m-4 6h1m10 3v.5a3.5 3.5 0 1 0 3.5-3.5H9m-7-3h6m7-3v-.5a3.5 3.5 0 1 1 3.5 3.5h-6.25"/></svg><p>Wind Speed</p></div>
						<span className='text-lg md:text-xl font-bold '>{weather.data.wind.speed} m/s</span>		
					</div>
					<div className='data-element'>
